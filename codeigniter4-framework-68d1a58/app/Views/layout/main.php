    ...
    <div class="search-filters">
        ...
        <div class="filters">
            <div class="filter-group">
                ...
                <a href="/" class="filter-btn <?= empty($currentCategory) ? 'active' : '' ?>">Toutes</a>
                <?php if (!empty($categories)): ?>
                    <?php foreach ($categories as $cat): ?>
                        <a href="/?category=<?= urlencode($cat['category']) ?>" class="filter-btn <?= ($currentCategory ?? '') === $cat['category'] ? 'active' : '' ?>">
            ...
            <div class="filter-group">
                ...
                <?php if (!empty($tags)): ?>
                    <?php foreach ($tags as $t): ?>
                        <a href="/?tag=<?= urlencode($t) ?>" class="filter-btn <?= ($currentTag ?? '') === $t ? 'active' : '' ?>">
                            <?= esc($t) ?>
                        </a>
                    <?php endforeach; ?>
                <?php endif; ?>
